...
export const metadata = pageMeta({
  ...
  description:
    `Learn about Nicolla Contractors Ltd, a premium home refurbishment company in Kings Langley, Hertfordshire. Reliable, professional builders rated ${site.rating}/5 by ${site.reviewCount}+ customers.`,
  path: "/about",
});
